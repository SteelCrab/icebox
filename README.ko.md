...
- **슬래시 명령어** — 보드 관리, AI 제어, 인증을 위한 18개 명령어
...
| | `/export` | 보드 마크다운 내보내기 |
| | `/diff` | Git diff |
| | `/swimlane [name \| clear]` | 스윔레인 설정/목록 |
| **AI** | `/help` | 명령어 목록 |
| | `/status` | 세션 상태 |
| | `/cost` | 토큰 비용 |
| | `/clear` | 대화 초기화 |
...
crates/
  ...
  commands/     # 슬래시 명령어 18개 (Board, AI, Auth, Session)
```
...
| `update_task` | 기존 태스크 수정 (제목, 우선순위, 태그, 날짜, 스윔레인, 본문) |
| `move_task` | 태스크 컬럼 이동 |
